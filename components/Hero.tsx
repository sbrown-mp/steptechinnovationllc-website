      ...
      <Container>
        ...
        >
          ...
          <div className="relative z-10 mx-auto max-w-4xl text-center">
            <p className="eyebrow">Built for Florida service operators</p>
            <h1 className="mt-6 text-4xl font-semibold leading-tight text-white md:text-6xl">
              Stop losing revenue to
              <span className="gradient-text"> scheduling chaos and admin bottlenecks.</span>
            </h1>
            <p className="mx-auto mt-6 max-w-3xl text-lg text-cyan-50/95 md:text-xl">
              We design and deploy custom workflow systems that reduce office labor, eliminate missed follow-ups,
              and speed up invoicing for teams in HVAC, plumbing, electrical, home health, property management,
              and construction.
            </p>
