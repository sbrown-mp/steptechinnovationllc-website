        ...
        <Container>
          <div className="glass-card bg-gradient-to-r from-slate-900/90 via-slate-800/70 to-cyan-950/50 p-8 md:p-10">
            ...
            <h2 className="mt-5 text-3xl font-semibold text-white md:text-4xl">
              Get a Workflow Audit and a practical build plan you can act on immediately.
            </h2>
            <p className="mt-4 max-w-3xl text-slate-200">
              We will identify the highest-impact process to improve first, estimate ROI, and map delivery milestones so
